...
"root://eostotem//eos/totem/data/offline/2018/450GeV/beta100/Totem1/version5/run_324519.1_re_reco_Totem1.root",
)
)
...
#  ctppsDiamondRecHits = cms.untracked.InputTag('ctppsDiamondRecHits'),
  ...
  outputFileName = cms.string("output_LBRT_run_324519.1_re_reco_Totem1.root"),
