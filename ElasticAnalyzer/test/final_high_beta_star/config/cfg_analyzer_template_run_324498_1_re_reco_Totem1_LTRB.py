...
"root://eostotem//eos/totem/data/offline/2018/450GeV/beta100/Totem1/version5/run_324498.1_re_reco_Totem1.root",
)
)
...
#  ctppsDiamondRecHits = cms.untracked.InputTag('ctppsDiamondRecHits'),
  ...
  outputFileName = cms.string("output_LTRB_run_324498.1_re_reco_Totem1.root"),
