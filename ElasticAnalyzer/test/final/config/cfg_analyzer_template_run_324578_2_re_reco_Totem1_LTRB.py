...
"root://eostotem//eos/totem/data/offline/2018/450GeV/beta11/Totem1/version5/run_324578.2_re_reco_Totem1.root",
)
)
...
#  ctppsDiamondRecHits = cms.untracked.InputTag('ctppsDiamondRecHits'),
  ...
  outputFileName = cms.string("output_LTRB_run_324578.2_re_reco_Totem1.root"),
